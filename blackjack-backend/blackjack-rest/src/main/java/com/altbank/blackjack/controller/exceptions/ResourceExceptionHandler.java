package com.altbank.blackjack.controller.exceptions;
...
import com.altbank.blackjack.service.exceptions.DataIntegrityException;
...
public class ResourceExceptionHandler {
	...
	public ResponseEntity<StandardError> dataIntegrity(BlackjackException e, HttpServletRequest request) {
		StandardError err = new StandardError(HttpStatus.BAD_REQUEST.value(), e.getMessage(),
				System.currentTimeMillis());
		return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(err);
	}
